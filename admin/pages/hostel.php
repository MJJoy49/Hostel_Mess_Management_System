<div class="page-wrapper">
    ...
    <div class="modal" id="editModal">
      <div class="modal-content">
        ...
        <!-- IMPORTANT: form is direct child of .modal-content -->
        <form id="editForm">
          <div class="modal-body">
            ...
            <div class="form-grid">
              ...
              <div class="form-group form-group--wide">
                <label for="edit_photo">Profile Photo URL</label>
                <input type="text" id="edit_photo" class="form-control">
                <span class="input-inline-help">Paste image URL. Leave empty to keep current.</span>
              </div>
            </div>
